...
const Filter = () => {
  ...
  return (
    <div className="filter">
      <div className="flex-row align-center-flex justify-center-flex justify-space-between-flex">
        <h2>Filters</h2>
        <p
      ...
      <div className="filter-type-item">
        ...
        <div className="flex-col filter-type-option">
          <label htmlFor="sort-by-price">
            <input
              ...
              checked={
                productState.sortBy && productState.sortBy === HIGH_TO_LOW
              }
            />
            High to low
          </label>
          <label htmlFor="sort-by-price">
            <input
              ...
              checked={
                productState.sortBy && productState.sortBy === LOW_TO_HIGH
              }
            />
            Low to high
          </label>
      ...
      <div className="filter-type-item">
        <h3>Size</h3>
        <div className="flex-row sizes-filter filter-type-option">
      ...
      <div className="filter-type-item">
        ...
        <div className="filter-by-delivery">
