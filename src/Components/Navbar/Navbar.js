    ...
    return (
        <header>
            <nav className="navbar flex-row justify-space-between-flex align-center-flex">
                <Link to="/" className="curs-point"><h2>SHOEDOG</h2></Link>
                <div className="mid-nav-links-container flex-row align-center-flex justify-center-flex">
                    <Link to="/" className="curs-point">Home</Link>
                    <Link to="/product" className="curs-point">Products</Link>
                </div>
                <div className="right-nav-links-container flex-row align-center-flex justify-center-flex">
                    ...
                    <div>
                        <Link to="/wishlist" className="curs-point">Wishlist</Link>
                    </div>
                    <div>
                        <Link to="/cart" className="curs-point">Add to cart</Link>
                    </div>
